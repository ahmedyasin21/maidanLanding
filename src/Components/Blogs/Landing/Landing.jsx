...
class Landing extends Component {
  ...
  <div className="container">
    <div className="flex">
      {/* 1 */}
      <div className="content"> <div className="container content mt-5">
          <div className="row r-list">
            <div className="col-4 img-b"><img src="../img/blog/blog1L.png" alt="" /></div>
            <div className="col-8 text-b mt-2">
              <h5>5 indoor sports to keep you active over winter:
              </h5>
              <p>
                How well are all those pledges and resolutions to get more active holding up after a month into the New Year?<br />
      ...
      <div className="content"> <div className="container content mt-5">
          <div className="row r-list">
            <div className="col-4 img-b"><img src="../img/blog/blog2L.png" alt="" /></div>
            <div className="col-8 text-b mt-2">
              <h5>
      ...
      <div className="content"> <div className="container content mt-5">
          <div className="row r-list">
            <div className="col-4 img-b"><img src="../img/blog/blog3L.png" alt="" /></div>
            <div className="col-8 text-b mt-2">
              <h5>
      ...
      <div className="content"> <div className="container content mt-5">
          <div className="row r-list">
            <div className="col-4 img-b"><img src="../img/blog/blog4L.png" alt="" /></div>
            <div className="col-8 text-b mt-2">
              <h5>
                What is Padel Tennis?
              </h5>
              <p>
                One of the grassroots sports with the quickest growth in Pakistan is padel tennis. In the Pakistan, the sport has kept gaining popularity.
              </p>
      ...
      <div className="content"> <div className="container content mt-5">
          <div className="row r-list">
            <div className="col-4 img-b"><img src="../img/blog/blog5L.png" alt="" /></div>
            <div className="col-8 text-b mt-2">
              <h5>
      ...
      <div className="content"> <div className="container content mt-5">
          <div className="row r-list">
            <div className="col-4 img-b"><img src="../img/blog/blog6L.png" alt="" /></div>
            <div className="col-8 text-b mt-2">
              <h5>
      ...
      <div className="content"> <div className="container content mt-5">
          <div className="row r-list">
            <div className="col-4 img-b"><img src="../img/blog/blog7L.png" alt="" /></div>
            <div className="col-8 text-b mt-2">
              <h5>
